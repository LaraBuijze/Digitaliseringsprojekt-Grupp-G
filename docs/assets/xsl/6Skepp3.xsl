...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:teiCorpus">
        ...
        <html lang="sv" xml:lang="sv">
            <head>
                <title>Skeppsritningar av F.H. af Chapman: Skepp om 52 kanoner</title>
                <link rel="stylesheet"
                                        ...
                                        <article id="PL.VII.A.">
                                            <img class="img-full">
                                                <xsl:attribute name="src">
                                                  <xsl:value-of
                                                      select="//tei:surfaceGrp[@n = 'PL.VII.A.']/tei:surface/tei:graphic[@xml:id = 'pl-vii-a-thumbnail']/@url"
                                                  />
                                                </xsl:attribute>
                                ...
                                <div class="col-sm">
                                    <div class="row">
                                        <article class="transkription">
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.A.']/tei:text/tei:body/tei:div[@type = 'transkription']/tei:p"
                                            />
                                        </article>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="row">
                                        <article class="metadata">
                                            ...
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.A.']/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:biblStruct/tei:analytic/tei:author"/>
                                            <br/>
                                            <u>Beskrivning:</u>
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.A.']/tei:text/tei:body/tei:div[@type = 'beskrivning']/tei:p"
                                            />
                                        </article>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="row">
                                        <article class="metadata">
                                            ...
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.A.']/tei:teiHeader/tei:profileDesc/tei:textClass/tei:keywords"/>
                                            <br/>
                                    ...
                                    <div class="row">
                                        <article id="PL.VII.B.">
                                            <img class="img-full">
                                                <xsl:attribute name="src">
                                                  <xsl:value-of
                                                      select="//tei:surfaceGrp[@n = 'PL.VII.B.']/tei:surface/tei:graphic[@xml:id = 'pl-vii-b-thumbnail']/@url"
                                                  />
                                                </xsl:attribute>
                                                <xsl:attribute name="title">
                                                  <xsl:value-of
                                ...
                                <div class="col-sm">
                                    <div class="row">
                                        <article class="metadata">
                                            ...
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.B.']/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:biblStruct/tei:analytic/tei:author"/>
                                            <br/>
                                            <u>Beskrivning:</u>
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="row">
                                        <article class="metadata">
                                            ...
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.B.']/tei:teiHeader/tei:profileDesc/tei:textClass/tei:keywords"/>
                                            <br/>
                                            <u>Digitaliserats av:</u>
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                    ...
                                    <div class="row">
                                        <article id="PL.VII.C.">
                                            <img class="img-full">
                                                <xsl:attribute name="src">
                                                  <xsl:value-of
                                                      select="//tei:surfaceGrp[@n = 'PL.VII.C.']/tei:surface/tei:graphic[@xml:id = 'pl-vii-c-thumbnail']/@url"
                                                  />
                                                </xsl:attribute>
                                                <xsl:attribute name="title">
                                                  <xsl:value-of
                                ...
                                <div class="col-sm">
                                    <div class="row">
                                        <article class="metadata">
                                            ...
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.C.']/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:biblStruct/tei:analytic/tei:author"/>
                                            <br/>
                                            <u>Beskrivning:</u>
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                ...
                                <div class="col-sm">
                                    <div class="row">
                                        <article class="metadata">
                                            ...
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
                                                select="//tei:TEI[@xml:id = 'PL.VII.C.']/tei:teiHeader/tei:profileDesc/tei:textClass/tei:keywords"/>
                                            <br/>
                                            <u>Digitaliserats av:</u>
                                            <xsl:text> </xsl:text>
                                            <xsl:apply-templates
